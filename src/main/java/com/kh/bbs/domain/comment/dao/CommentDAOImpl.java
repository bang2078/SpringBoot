...
public class CommentDAOImpl  implements CommentDAO {
  ...
  public Long save(Long id ,Comment comment) {
    ...
    sql.append(" INSERT INTO comments (name,content,board_id) ");
  ...
  public Long update(Long id, Comment comment) {
    ...
    sql.append("    SET name = :name, content = :content, create_time = systimestamp ");
  ...
  public List<Comment> findAll(Integer pid,Integer pageNo , Integer numOfRows) {
    ...
    StringBuffer sql = new StringBuffer();
    sql.append("    SELECT comment_id,name,content,create_time,board_id ");
  ...
  public int getTotalCount(Integer pid) {
    ...
    SqlParameterSource param = new MapSqlParameterSource().addValue("board_id",pid);
  ...
  public Optional<Comment> detail(Long id) {
    StringBuffer sql = new StringBuffer();
    sql.append(" SELECT comment_id, name, content, create_time ");
    sql.append("   FROM comments ");
    sql.append("  WHERE comment_id = :comment_id ");
